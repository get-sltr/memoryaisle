...
import { MiraAvatar } from '../../src/components/MiraAvatar';
...
const ListItemCard = memo(function ListItemCard({ item, onComplete, onDelete, onEdit, categoryColor }: { item: ListItem; onComplete: (id: string) => void; onDelete?: (item: ListItem) => void; onEdit?: (item: ListItem) => void; categoryColor?: string }) {
  ...
  return (
    <Pressable onPress={() => onComplete(item.id)} onLongPress={() => { Haptics.impactAsync(Haptics.ImpactFeedbackStyle.Light); onEdit?.(item); }} delayLongPress={400} style={styles.listItem}>
