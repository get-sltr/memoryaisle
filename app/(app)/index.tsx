            ...
            >
              ...
              >
                ...
                <View style={styles.menuItemInner}>
                  ...
                  <View style={styles.menuItemContent}>
                    <Text style={styles.menuItemText}>Pantry</Text>
                    <Text style={styles.menuItemSubtext}>Track what you have at home</Text>
                  </View>
                </View>
              </Pressable>
              ...
              >
                ...
                <View style={styles.menuItemInner}>
                  ...
                  <View style={styles.menuItemContent}>
                    ...
                    <Text style={styles.menuItemSubtext}>Track grocery spending</Text>
                  </View>
                </View>
              </Pressable>
              ...
              >
                ...
                <View style={styles.menuItemInner}>
                  ...
                  <View style={styles.menuItemContent}>
                    <Text style={styles.menuItemText}>Family Cookbook</Text>
                    <Text style={styles.menuItemSubtext}>Your family recipe collection</Text>
                  </View>
                </View>
              </Pressable>
              ...
              <Pressable
                ...
                onPress={() => {
                  setShowMenu(false);
                  router.push('/(app)/holiday-planner');
                }}
              >
                <BlurView intensity={25} tint="light" style={styles.menuItemBlur} />
                <LinearGradient
                ...
                <View style={styles.menuItemInner}>
                  ...
                  <View style={styles.menuItemContent}>
                    <Text style={styles.menuItemText}>Holiday Planner</Text>
                    <Text style={styles.menuItemSubtext}>Plan holiday feasts & prep timelines</Text>
                  </View>
                </View>
              </Pressable>
              ...
              <Pressable
                ...
                onPress={() => {
                  setShowMenu(false);
                  router.push('/(app)/barcode-scanner');
                }}
              >
                <BlurView intensity={25} tint="light" style={styles.menuItemBlur} />
                <LinearGradient
                ...
                <View style={styles.menuItemInner}>
                  ...
                  <View style={styles.menuItemContent}>
                    <Text style={styles.menuItemText}>Barcode Scanner</Text>
                    <Text style={styles.menuItemSubtext}>Scan products into your pantry</Text>
                  </View>
                </View>
              </Pressable>
              ...
              >
                ...
                <View style={styles.menuItemInner}>
                  ...
                  <View style={styles.menuItemContent}>
                    <Text style={styles.menuItemText}>Community Recipes</Text>
                    <Text style={styles.menuItemSubtext}>Discover & share recipes</Text>
                  </View>
                </View>
              </Pressable>
